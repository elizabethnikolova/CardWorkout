...
class CardSelectionViewController: UIViewController {
    ...
    let stopButton = CWButton(colour: .systemPurple, title: "STOP", systemImageName: "stop.circle")
    let resetButton = CWButton(colour: .systemCyan, title: "Reset", systemImageName: "arrow.clockwise")
    let rulesButton = CWButton(colour: .systemOrange, title: "Rules", systemImageName: "list.bullet")
    ...
    func startTimer() {
        timer = Timer.scheduledTimer(timeInterval: 0.1, target: self, selector: #selector(showRandomCard),
